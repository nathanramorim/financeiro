...
OUT_OF_SCOPE_MSG = (
    "Desculpe, sou um assistente focado exclusivamente em finanças pessoais e gestão de despesas/receitas. "
    "Sua solicitação parece estar fora do escopo financeiro permitido."
)
