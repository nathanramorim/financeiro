...
## 2. Guardrail Module (`src/guardrail/`)
...
## 3. Agente Financeiro & OpenRouter Client (`src/agent/`)
...
## 4. Módulo de Despesas (`src/tools/expenses.py`)
...
## 7. Calculadora On-Demand / MathTool (`src/tools/math_tool.py`)
...
## 8. Repositório Google Sheets (`src/services/sheets.py`)
