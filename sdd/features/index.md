# Index de Features — financeiro

## Dependency graph

```
main
├─ feat/01-agente-financeiro-chat (COMPLETED)
│  ├─ feat-01-01-foundation-ui-guardrail [done]
...
|---|---------|--------|------|--------|
| 01-01 | `feat-01-agente-financeiro-chat/feat-01-01-foundation-ui-guardrail.md` | `feat/01-agente-financeiro-chat` | 1 | done |
| 01-02 | `feat-01-agente-financeiro-chat/feat-01-02-openrouter-agent-math.md` | `feat/01-agente-financeiro-chat` | 2 | done |
| 01-03 | `feat-01-agente-financeiro-chat/feat-01-03-sheets-expenses-income.md` | `feat/01-agente-financeiro-chat` | 3 | done |
| 01-04 | `feat-01-agente-financeiro-chat/feat-01-04-categorization-refinement.md` | `feat/01-agente-financeiro-chat` | 4 | done |
| a102-01 | `feat-a102-migracao-api-nextjs/feat-a102-01-fastapi-backend.md` | `feat/a102-migracao-api-nextjs` | 1 | done |
